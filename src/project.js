        ...
        var o = e("HttpManagerJs"),
            ...
            r = (e("GameUiTools"), {
                ...
                gamePV_load: function() {
                    ...
                    // o.onreadystatechange = this.ajaxOnLogoResult, o.open("POST", e), o.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), o.send("gameID=" + this.gameHttpId)
                },
